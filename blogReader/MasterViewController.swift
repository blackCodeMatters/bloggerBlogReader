...
//  blogReader
//
//  Created by Dustin M on 2/24/16.
...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string:"https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyBFAE5Z7hSAGVBvuHtwyN3xpVw1z73JBnA")!;
        ...
        let task = session.dataTaskWithURL(url) { (data, response, error) -> Void in
            ...
            if error != nil {
                ...
                if let data = data {
                    ...
                    //testing to confirm pull of data with API
                    ...
                    do {
                        ...
                        if jsonResult.count > 0 {
                            ...
                            if let items = jsonResult ["items"] as? NSArray {
                                ...
                                //delete blog posts saved in memory so they are not duplicated when updated
